...
def ssl_attrib_updation(msrvr):
  ...
  ##print 'GracefulShutdownTimeout = 30'
  set('GracefulShutdownTimeout' , 30)

  ##print 'MSIFileReplicationEnabled = true '
  ...
  ##print 'ServerLifeCycleTimeoutVal = 120'
  set('ServerLifeCycleTimeoutVal', 120)


  ##print 'StagingMode = nostage'
  set('StagingMode' , 'nostage')

  ##print 'UploadDirectoryName = ./upload'
  set('UploadDirectoryName' , './upload')

  ##print 'IIOPEnabled = false'
  set('IIOPEnabled' , 'false')

  ##print 'StagingDirectoryName = ./stage'
  set('StagingDirectoryName' , './stage')

  ##print 'ClusterWeight = 100'
  set('ClusterWeight',100)
...
print ' PIA NAME : ' + msrvr + '.  Configuration script running . message from pythonscript'
